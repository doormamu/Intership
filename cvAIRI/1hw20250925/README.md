...
Исходные данные представляют собой оцифрованные стеклянные негативы, где три цветовых компоненты (Blue, Green, Red) расположены вертикально. Задача алгоритма: найти оптимальные векторы смещения для каждого канала, чтобы получить цветное изображение.
